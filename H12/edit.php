<?php
require_once "Crud.php";  // Pastikan Anda memiliki file Crud.php di folder yang benar.
...
if ($_SERVER["REQUEST_METHOD"] === "POST") { // Perbaiki tanda petik yang salah
    ...
    <div class="container mt-5">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <textarea name="keterangan" class="form-control" id="keterangan" rows="4" required><?php echo $tampil['keterangan']; ?></textarea>
            </div>
